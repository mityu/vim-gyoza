...
execute join(['function! vital#_gyoza#Vim#Vim9context#import() abort', printf("return map({'get_context': '', 'get_context_pos': '', '_vital_created': ''}, \"vital#_gyoza#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
